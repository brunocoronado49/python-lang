...
def get_random_wallpaper(folder_path):
    ...
    if not image_files:
        raise ValueError(f"No hay imagenes en la carpeta: {folder_path}")
    selected_image = random.choice(image_files)
    return selected_image


if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Selecciona un fondo")
    parser.add_argument("folder", type=str, help="Ruta de la carpeta")
